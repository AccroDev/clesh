    ...
    <div class="flex flex-col lg:flex-row max-w-[1100px] w-full bg-white dark:bg-[#2c1f15] rounded-xl overflow-hidden shadow-xl">
        ...
        <div class="hidden lg:flex flex-1 relative min-h-[600px] bg-primary/10">
            ...
            <div class="relative z-20 flex flex-col justify-end p-12 text-white">
                <h1 class="text-4xl font-bold mb-4">Conçu pour le confortt</h1>
                <p class="text-lg opacity-90 max-w-md">Découvrez une sélection triée sur le volet d'articles essentiels conçus pour apporter chaleur et style professionnel à votre quotidien.</p>
            </div>
        </div>
        ...
        <div class="flex-1 flex flex-col justify-center px-8 py-12 lg:px-16">
            <div class="w-full max-w-[420px] mx-auto">
                <!-- Header Section -->
                <div class="mb-8">
                    <h2 class="text-[#181411] dark:text-white text-3xl font-bold leading-tight tracking-[-0.015em] mb-2"> Content de te revoir</h2>
                    <p class="text-[#897261] dark:text-[#b0a095] text-base">Veuillez saisir vos informations pour vous connecter.</p>
                </div>
                <!-- Auth Tabs -->
                <div class="pb-6">
                    <div class="flex border-b border-[#e6e0db] dark:border-b-[#4a3a2d] gap-8">
                        <a href="/login" class="flex flex-col items-center justify-center border-b-[3px] border-b-transparent  text-[#897261] pb-[13px] pt-4" href="#">
                            <p class="text-sm font-bold leading-normal tracking-[0.015em]">Se connecter</p>
                        </a>
                        <a href="/signin" class="flex flex-col items-center justify-center border-b-[3px] border-b-primary text-primary dark:text-[#b0a095] pb-[13px] pt-4 hover:text-[#181411] dark:hover:text-white transition-colors" href="/signin">
                            <p class="text-sm font-bold leading-normal tracking-[0.015em]">S'inscrire</p>
                        </a>
                    </div>
                </div>
                <!-- Login Form -->
                <form class="space-y-4" action="/api/signin" method="POST">
                    <!-- name  field-->
                    <div class="flex flex-col w-full">
                        <p class="text-[#181411] dark:text-[#e6e0db] text-sm font-medium leading-normal pb-2">Noms</p>
                        <input class="form-input flex w-full min-w-0 resize-none overflow-hidden rounded-lg text-[#181411] dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#e6e0db] dark:border-[#4a3a2d] bg-white dark:bg-[#1a120b] focus:border-primary h-12 placeholder:text-[#897261] p-[15px] text-base font-normal leading-normal" placeholder="Ex: Jean" type="text" name="nom" />
                    </div>
                    <!-- Email Field -->
                    <div class="flex flex-col w-full">
                        <p class="text-[#181411] dark:text-[#e6e0db] text-sm font-medium leading-normal pb-2">Adresse email</p>
                    ...
                    <!-- Password Field -->
                    <div class="flex flex-col w-full">
                        <p class="text-[#181411] dark:text-[#e6e0db] text-sm font-medium leading-normal pb-2">Mot de passe</p>
                    ...
                    <div class="flex items-center justify-between py-2">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            ...
                            <span class="text-sm text-[#897261] dark:text-[#b0a095] group-hover:text-[#181411] dark:group-hover:text-white">Souviens-toi de moi</span>
                        </label>
                        <a class="text-sm font-semibold text-primary hover:underline" href="#">Mot de passe oublié ?</a>
                    </div>
                    <!-- CTA Button -->
                ...
                <p class="text-center mt-10 text-sm text-[#897261] dark:text-[#b0a095]">
                   Vous n'avez pas de compte ?
                    <a class="text-primary font-bold hover:underline ml-1" href="#">Créer un compte</a>
                </p>
            </div>
        </div>
    </div>
