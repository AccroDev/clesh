    ...
    <div class="max-w-[1280px] mx-auto flex items-center justify-between px-6 lg:px-10 py-4">
        <div class="flex items-center gap-12">
            ...
            <nav class="hidden md:flex items-center gap-8">
                ...
                <a class="text-[#181411] dark:text-[#f4f2f0] text-sm font-semibold hover:text-primary transition-colors" href="/products">Produits</a>
        ...
        <div class="flex flex-1 justify-end items-center gap-6">
            <div class="hidden lg:flex flex-1 max-w-sm">
                <label class="relative w-full">
                    <span class="absolute left-3 top-1/2 -translate-y-1/2 text-[#897261] material-symbols-outlined"></span>
