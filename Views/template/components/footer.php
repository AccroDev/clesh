<!-- Footer -->
<footer class="bg-white dark:bg-[#1a120b] border-t border-[#f4f2f0] dark:border-[#3d2e21] px-6 lg:px-10 py-16">
    <div class="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div class="flex flex-col gap-6">
            ...
            <div class="flex gap-4">
                ...
                <a class="text-[#897261] hover:text-primary transition-colors" href="#"><span class="material-symbols-outlined">alternate_email</span></a>
                <a class="text-[#897261] hover:text-primary transition-colors" href="#"><span class="material-symbols-outlined">share</span></a>
            </div>
        </div>
        <div class="flex flex-col gap-6">
