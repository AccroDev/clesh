    ...
    <div class="p-6 flex flex-col gap-8 h-full">
        ...
        <div class="flex gap-3 items-center">
            ...
            <div class="flex flex-col">
                <h1 class="text-[#181411] dark:text-white text-base font-bold leading-normal">Store Admin</h1>
        ...
        <nav class="flex flex-col gap-1 grow">
            ...
            <div class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-[#181411] hover:bg-background-light  cursor-pointer">
        ...
        <div class="flex flex-col gap-1 border-t border-[#e6e0db] dark:border-white/10 pt-4">
            ...
            <div class="flex items-center gap-3 px-3 py-2.5 cursor-pointer rounded-lg hover:bg-background-light dark:hover:bg-white/5 text-[#e71008]">
