...
<div class="bg-white dark:bg-[#1c140d] rounded-xl border border-[#e6e0db] dark:border-white/10 p-6 mb-8 shadow-sm">
    <h2 class="text-[#181411] dark:text-white text-lg font-bold mb-4">Ajout rapide de produit</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <label class="cursor-pointer group" for="image">
            <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold text-[#897261] uppercase tracking-wider">Aperçu (Cliquez pour télécharger)</label>
        ...
        <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold text-[#897261] uppercase tracking-wider">Nom du produit</label>
            ...
            <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold text-[#897261] uppercase tracking-wider">Categories</label>
                <select default="<?= isset($editItem["categori"]) ? $editItem["categori"] : '' ?>" class="h-11 rounded-lg border-[#e6e0db] dark:border-white/10 bg-background-light dark:bg-background-dark text-sm" name="categori">
                    ...
                    <option>Maison et décoration</option>
                </select>
            </div>

            <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold text-[#897261] uppercase tracking-wider">Prix ​​et appareil</label>
        ...
        <div class="flex flex-col gap-4">
            ...
            <button type="submit" class="bg-primary text-white font-bold h-11 rounded-lg hover:bg-opacity-90 transition-all flex items-center justify-center gap-2 w-full mt-auto">
                <span class="material-symbols-outlined">add</span> Ajouter un produit
            </button>
        </div>
