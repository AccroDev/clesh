    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-1.5">
                ...
                <input class="h-11 rounded-lg border-[#e6e0db] dark:border-white/10 bg-background-light dark:bg-background-dark focus:border-primary text-sm" name="nom" type="text" placeholder="Name" />
            </div>

            <div class="flex flex-col gap-1.5">
                <label class="text-xs font-semibold text-[#897261] uppercase tracking-wider">Category</label>
                <select class="h-11 rounded-lg border-[#e6e0db] dark:border-white/10 bg-background-light dark:bg-background-dark text-sm" name="categori">
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <div class="flex gap-1">
                    <input class="h-11 w-2/3 rounded-lg border-[#e6e0db] dark:border-white/10 bg-background-light text-sm" type="number" name="prix" placeholder="0.00" />
                    <select class="h-11 w-1/3 rounded-lg border-[#e6e0db] dark:border-white/10 bg-background-light text-sm" name="devise">
        ...
        <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-1.5">
                ...
                <textarea name="description" class="h-[105px] rounded-lg border-[#e6e0db] dark:border-white/10 bg-background-light dark:bg-background-dark focus:border-primary text-sm p-3 resize-none" placeholder="Enter details..."></textarea>
            </div>
